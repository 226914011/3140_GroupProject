            ...
            <Dialog title="FAQ" actions={dialogActions}>
                <div className={styles.faq}>
                    <p>
                        ...
                        <strong>A:</strong> No, data have to be manually updated by running <a rel="noopener noreferrer" target="_blank" href="https://github.com/TCWPanda">this page</a> to obtain and save data from <a rel="noopener noreferrer" target="_blank" href="https://github.com/226914011">HKCC Project team </a> by crawling and parsing the website, i.e. data are correct up to the latest time of running the data retrieving page.<br />
                    </p>
                    <p>
                    ...
                    <p>
                        <strong>If you any enquires, please find us on <a href="https://github.com/226914011">our Github page</a>.</strong><br />
                    </p>
                    <p>
                        <strong>GitHub:</strong> <a rel="noopener noreferrer" target="_blank" href="https://github.com/TCWPanda">https://github.com/TCWPanda</a><br />
                    </p>
                    <p>
                        <strong>This website is contributed by :</strong> Alan Chung, Antony Tse<br />
                        <strong>And rebuild by :</strong> Alan Tang<br />
                    </p>
                </div>
            </Dialog>
        </Presentation>
